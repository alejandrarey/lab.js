...
for (let i = 0; i < nums.length; i++) {if (nums[i] % 2 === 0) {evensArr.push(nums[i])}
}
...
//Code Here
if(score >= 90) {console.log("A")} else if(score >= 80 && score <= 90) {console.log('B')} else if(score >= 70 && score <=79) {console.log('C')} 
else if(score >= 60 && score <=69) {console.log('C')} else {console.log('F')} 
...
//Code Here
for (let i = letters.lenght -1; i >= 0; i--) {
...
for (let i = 1; i <= 100; i++) {if (i % 3 === 0 && i % 5 === 0) {
